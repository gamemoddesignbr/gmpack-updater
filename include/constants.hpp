...
constexpr const char GITHUB_USER[] = "gamemoddesignbr";
constexpr const bool SHOW_OTHER = true;
...
constexpr const char NXLINKS_URL[] = "https://raw.githubusercontent.com/gamemoddesignbr/nx-links/master/nx-links-v205.json";
